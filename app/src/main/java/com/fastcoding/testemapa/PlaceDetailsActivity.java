package com.fastcoding.testemapa;

/**
 * Created by Italo on 16/10/2015.
 */
...
public class PlaceDetailsActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //sb.append("&types=taxi_stand");
        sb.append("&key=AIzaSyDpA1M0OAO-4YPs4cavzR4WQmlJY5mcic4");//YOUR_BROWSER_API_KEY_FOR_PLACES
    ...
    private String downloadUrl(String strUrl) throws IOException{
        ...
        try{
            ...
            Log.d("Exception w. d. url", e.toString());// Exception while downloading url
        }finally{
            iStream.close();
